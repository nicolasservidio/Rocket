...
.form-control:focus {
    ...
    <div class="wrapper" style="margin-bottom: 100px; min-height: 100%;">
        ...
        <div class="container" style="margin-top: 10%; margin-left: 1%; margin-right: 1%;">
            ...
            <div style="margin-bottom: 110px; padding: 35px; max-width: 97%; background-color: white; border: 1px solid rgb(223, 115, 14); border-radius: 14px;">
                ...
                <form class="row g-3" action="entregaVehiculo.php" method="get">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <button type="submit" style="background-color:rgb(223, 115, 14); color: white;" class="btn w-100" name="BotonFiltrar" value="FiltrandoEntregas">
            ...
            <div style="margin-top: 5%; padding-bottom: 100px;">
                <div class="table-responsive mt-4" style="max-width: 97%; max-height: 700px; border: 1px solid #444444; border-radius: 14px;">
                    <table class="table table-striped table-hover" id="tablaEntregas">
                        <thead>
                            <tr>
                                <th style='color:rgb(223, 115, 14);'><h3>#</h3></th>
                                <th>Contrato</th>
                                <th>Fecha Ret.</th>
                                <th>Hora Ret.</th>
                                <th>Cliente</th>
                        ...
                        <tbody>
                            ...
                            for ($i=0; $i < $CantidadEntregas; $i++) { ?>     
                                ...
                                <tr class='entrega' data-id='<?php echo $ListadoEntregas[$i]['IdEntrega']; ?>' 
                                    ...
                                    <td><span style='color:rgb(223, 115, 14);'><h4> <?php echo $contador; ?> </h4></span></td>
                            ...
                            <form action="Nueva_Entrega.php" method="post">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="fechaentrega" name="fechaentrega" value="" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="horaentrega" class="form-label">Hora de Entrega</label>
                                        <input type="time" class="form-control" id="horaentrega" name="horaentrega" value="" required>
                                    </div>

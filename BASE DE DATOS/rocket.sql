...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-04-2025 a las 17:40:14
...
CREATE TABLE `proveedores` (
  ...
  `ivaProveedor` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
(4, 'Litoral Gas S.A', 'litoralgas@gmail.com', 'Av Malvinas Argentin 829', 2477610676, '', NULL, 1111111111111111, 'Responsable Inscripto'),
(7, 'LUCIA', 'lucia@hotmail.com', 'pergamino', 32456787866, '', NULL, 345346375378578, 'Monotributo Cat. A'),
(8, 'Nicolas Servidio', 'nicoservidio@gmail.com', 'Bahia Blanca', 123546758, '', NULL, 132465758, 'Monotributo Cat. B');

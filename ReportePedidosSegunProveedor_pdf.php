        ...
        <div class="" style="">
            ...
            <div class="p-5 mb-4 bg-white shadow-sm table-responsive" 
                ...
                <h4 class="mb-4 text-secondary" style="padding-bottom: 10px;">
                    <strong>Reporte: Pedidos a proveedores según proveedor seleccionado </strong>
                </h4>
...
$dompdf->stream("Reporte-Pedidos-según-Proveedor", array("Attachment" => false)); // false es para que se abra directamente en el navegador. True es para que se descargue

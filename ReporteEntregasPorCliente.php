        ...
        <div class="wrapper" style="margin-bottom: 0; min-height: 100%;">
            <div class="container" style="max-width: 97%;">
                ...
                <div class="table-responsive p-5 mb-4 bg-white shadow-sm" style="max-width: 97%; max-height: 700px; margin-top: 10%;">
                    ...
                    <?php // solo genero el reporte si $ListadoEntregas no está vacío
                    
                    if(!empty($ListadoEntregas)) {?>     
            ...
            <div style="margin-top: 5%; margin-bottom: 5%;">
                <div class="container d-flex justify-content-center">
                    ...
                    <?php if(!empty($ListadoEntregas)) {?>     
                    <a href="ReporteEntregasPorCliente_pdf.php?mensaje=<?php echo urlencode($idCliente); ?> "> 
